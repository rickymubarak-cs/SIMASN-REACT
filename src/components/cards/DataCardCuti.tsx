...
import { User, Clock, Eye, Edit, Ban, CheckCircle, Upload, Coffee, FileCheck } from 'lucide-react';
import { StatusBadge } from '../common/StatusBadge';
import { formatDateTimeId } from '../../utils/formatters';
import { cutiFileConfig } from '../../service/cutiService';

interface DataCardCutiProps {
    data: any;
    index: number;
    onDetail: () => void;
    onPerbaiki?: () => void;
...
export const DataCardCuti: React.FC<DataCardCutiProps> = ({
    data,
    index,
    onDetail,
    onPerbaiki,
