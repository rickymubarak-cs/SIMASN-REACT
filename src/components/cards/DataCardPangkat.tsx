...
import { User, Clock, Eye, Edit, Ban, CheckCircle, Upload, TrendingUp, FileCheck } from 'lucide-react';
    ...
    return (
        <div className="bg-white rounded-[3rem] border border-slate-200/60 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all group flex flex-col overflow-hidden relative">
            <div className="p-6 flex-1">
                ...
                <p className="text-[9px] text-purple-600 bg-purple-50 px-2 py-0.5 rounded-full inline-flex items-center gap-1 mb-3">
                    <TrendingUp size={10} />
                    {jenisKenaikan}
                </p>
            ...
            <div className="bg-slate-50/50 p-4 space-y-2 border-t border-slate-100">
                ...
                {/* File indicators - tampilkan 3 file pertama */}
                <div className="flex gap-1 pt-1 flex-wrap">
                    {pangkatFileConfig.slice(0, 3).map(fileConfig => (
