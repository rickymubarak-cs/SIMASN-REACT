// src/components/cards/Pelayanan/Admin/Cuti/DataCardCutiCompact.tsx

import React, { useState } from 'react';
import { Calendar, Eye, Edit, Ban, CheckCircle, Upload, Loader, FileCheck } from 'lucide-react';
    ...
    return (
        <div className="bg-white rounded-xl border border-slate-200 hover:shadow-lg hover:border-cyan-200 transition-all group">
            <div className="p-3">
                ...
                <div className="text-[9px] text-cyan-600 bg-cyan-50 px-1.5 py-0.5 rounded-full inline-block mb-1">
                    {jenisCuti}
                </div>
                ...
                <div className="flex gap-1 mt-2 pt-2 border-t border-slate-100">
                    <button
                        ...
                        className="flex-1 py-1.5 rounded-lg text-[9px] font-bold bg-slate-50 text-slate-600 hover:bg-cyan-50 hover:text-cyan-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-1"
                    >
