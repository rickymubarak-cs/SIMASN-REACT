// src/components/cards/Pelayanan/Admin/Cuti/DataCardCutiDetailed.tsx

import React, { useState } from 'react';
import { Calendar, Clock, Eye, Edit, Ban, CheckCircle, Upload, Calendar as CalendarIcon, Building, FileCheck, Loader } from 'lucide-react';
            ...
            <div className="p-5">
                ...
                <div className="flex gap-2 pt-3 border-t border-slate-100">
                    <button
                        ...
                        className="flex-1 py-2 rounded-xl text-xs font-bold bg-slate-100 text-slate-700 hover:bg-cyan-100 hover:text-cyan-700 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                    ...
                    {(status === "diterima" || status === "selesai") && (
                        <button
                            ...
                            className={`flex-1 py-2 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-2 ${status === "selesai"
                                    ? 'bg-cyan-100 text-cyan-700 hover:bg-cyan-600 hover:text-white'
