// src/components/cards/Pelayanan/Admin/Diklat/DataCardDiklatCompact.tsx

import React, { useState } from 'react';
import { BookOpen, Eye, Edit, Ban, CheckCircle, Upload, Loader, FileCheck } from 'lucide-react';
    ...
    return (
        <div className="bg-white rounded-xl border border-slate-200 hover:shadow-lg hover:border-sky-200 transition-all group">
            <div className="p-3">
                ...
                <div className="text-[8px] text-slate-600 line-clamp-2 mb-1">
                ...
                <div className="flex gap-1 mt-2 pt-2 border-t border-slate-100">
                    <button
                        ...
                        className="flex-1 py-1.5 rounded-lg text-[9px] font-bold bg-slate-50 text-slate-600 hover:bg-sky-50 hover:text-sky-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-1"
                    >
