// src/components/cards/Pelayanan/Admin/Gaji/DataCardGajiDetailed.tsx

import React, { useState } from 'react';
import { DollarSign, Clock, Eye, Edit, Ban, CheckCircle, Upload, Calendar, Building, TrendingUp, FileCheck, Loader } from 'lucide-react';
            ...
            <div className="p-5">
                ...
                <div className="flex gap-2 pt-3 border-t border-slate-100">
                    <button
                        ...
                        className="flex-1 py-2 rounded-xl text-xs font-bold bg-slate-100 text-slate-700 hover:bg-teal-100 hover:text-teal-700 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
