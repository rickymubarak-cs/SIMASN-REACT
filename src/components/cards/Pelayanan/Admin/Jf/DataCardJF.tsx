            ...
            <div className="p-6 flex-1">
                ...
                <div className="mb-3">
                    <div className="flex items-start gap-1.5">
                        <Building size={10} className="text-indigo-400 mt-0.5 flex-shrink-0" />
                ...
                <div className="flex flex-wrap gap-1 mb-2">
                    <span className="text-[9px] text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded-full inline-flex items-center gap-1">
                        <Award size={10} />
                        {jenisJf}
                    </span>
                </div>
