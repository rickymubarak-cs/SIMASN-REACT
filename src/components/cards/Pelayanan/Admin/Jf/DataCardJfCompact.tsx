// src/components/cards/Pelayanan/Admin/Jf/DataCardJfCompact.tsx

import React, { useState } from 'react';
import { Briefcase, Eye, Edit, Ban, CheckCircle, Upload, Loader, FileCheck } from 'lucide-react';
    ...
    return (
        <div className="bg-white rounded-xl border border-slate-200 hover:shadow-lg hover:border-indigo-200 transition-all group">
            <div className="p-3">
                ...
                <div className="text-[9px] text-indigo-600 bg-indigo-50 px-1.5 py-0.5 rounded-full inline-block mb-1">
                    {jenisJf}
                </div>
                ...
                <div className="flex gap-1 mt-2 pt-2 border-t border-slate-100">
                    <button
                        ...
                        className="flex-1 py-1.5 rounded-lg text-[9px] font-bold bg-slate-50 text-slate-600 hover:bg-indigo-50 hover:text-indigo-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-1"
                    >
