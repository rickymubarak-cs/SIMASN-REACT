// src/components/cards/Pelayanan/Admin/Lpp/DataCardLppCompact.tsx

import React, { useState } from 'react';
import { GraduationCap, Eye, Edit, Ban, CheckCircle, Upload, Loader, FileCheck } from 'lucide-react';
import { StatusBadge } from '../../../../common/StatusBadge';

interface DataCardLppCompactProps {
    data: any;
    index: number;
    onDetail: () => void;
    onPerbaiki?: () => void;
...
export const DataCardLppCompact: React.FC<DataCardLppCompactProps> = ({
    data,
    index,
    onDetail,
    onPerbaiki,
