// src/components/cards/Pelayanan/Admin/Pltplh/DataCardPltplh.tsx

import React, { useState } from 'react';
import { UserCog, Clock, Eye, Edit, Ban, CheckCircle, Upload, FileCheck, Building, Loader } from 'lucide-react';
import { StatusBadge } from '../../../../common/StatusBadge';
import { formatDateTimeId } from '../../../../../utils/formatters';
import { pltplhFileConfig } from '../../../../../service/pltplhService';

interface DataCardPltplhProps {
    data: any;
    index: number;
    onDetail: () => void;
    onPerbaiki?: () => void;
...
export const DataCardPltplh: React.FC<DataCardPltplhProps> = ({
    data,
    index,
    onDetail,
    onPerbaiki,
    ...
    const availableFiles = pltplhFileConfig.filter(
        ...
        <div className="bg-white rounded-[3rem] border border-slate-200/60 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all group flex flex-col overflow-hidden relative">
            <div className="p-6 flex-1">
                ...
                <p className="text-[9px] text-slate-500 bg-slate-50 px-2 py-1 rounded-full inline-flex items-center gap-1 mb-3">
                    <FileCheck size={10} />
                    {availableFiles} dari {pltplhFileConfig.length} Berkas tersedia
                </p>
            ...
            <div className="bg-slate-50/50 p-4 space-y-2 border-t border-slate-100">
                ...
                <div className="flex gap-1 pt-1 flex-wrap">
                    {pltplhFileConfig.slice(0, 4).map(fileConfig => (
