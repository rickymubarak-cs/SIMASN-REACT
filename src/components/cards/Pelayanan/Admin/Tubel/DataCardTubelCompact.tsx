// src/components/cards/Pelayanan/Admin/Tubel/DataCardTubelCompact.tsx
    ...
    return (
        <div className="bg-white rounded-xl border border-slate-200 hover:shadow-lg hover:border-blue-200 transition-all group">
            <div className="p-3">
                ...
                <div className="text-[9px] text-blue-600 bg-blue-50 px-1.5 py-0.5 rounded-full inline-block mb-1">
                    Usia: {data?.layanan_tubel_usia || 0} tahun
                </div>
                ...
                <div className="flex gap-1 mt-2 pt-2 border-t border-slate-100">
                    <button
                        ...
                        className="flex-1 py-1.5 rounded-lg text-[9px] font-bold bg-slate-50 text-slate-600 hover:bg-blue-50 hover:text-blue-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-1"
                    >
