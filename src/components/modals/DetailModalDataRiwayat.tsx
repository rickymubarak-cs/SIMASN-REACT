...
import {
    X, User, Building, Paperclip, FileCheck, Clock, Info, Database, Eye, ExternalLink,
    Mail, FileText
} from 'lucide-react';
...
interface DetailModalDataRiwayatProps {
    isOpen: boolean;
    onClose: () => void;
    data: any;
}
...
export const DetailModalDataRiwayat: React.FC<DetailModalDataRiwayatProps> = ({
    isOpen,
    onClose,
    data
}) => {
    ...
    const jenisLayanan = data.jenis_layanan_data || "Peremajaan Data Riwayat";
                        ...
                        <div className="flex justify-between items-start">
                            <div>
                                ...
                                <p className="text-sky-100 text-xs mt-1">
                                    Informasi lengkap pengajuan peremajaan data riwayat pegawai
                                </p>
                            </div>
                            ...
                            <div className="md:col-span-1 space-y-4">
                                ...
                                <div className="text-center">
                                    {fotoUrl ? (
                                        <img
                                            src={fotoUrl}
                                            alt={namaLengkap}
                                            className="w-32 h-32 rounded-full object-cover mx-auto border-4 border-sky-200 shadow-lg"
                                            onError={(e) => {
                                                e.currentTarget.style.display = "none";
                                                const parent = e.currentTarget.parentElement;
                                                if (parent) {
                                                    const fallback = document.createElement('div');
                                                    fallback.className = "w-32 h-32 rounded-full bg-gradient-to-br from-sky-500 to-sky-600 text-white flex items-center justify-center text-5xl font-black mx-auto border-4 border-sky-200 shadow-lg";
                                ...
                                <div className="bg-slate-50 rounded-2xl p-4">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div>
                                            <p className="text-[10px] text-slate-400">Jenis Layanan</p>
                                            <p className="font-medium text-slate-700 text-sm">{jenisLayanan}</p>
                                        </div>
                                        {ketPerbaikan && (
                                            <div>
                                                <p className="text-[10px] text-slate-400">Permohonan Perbaikan</p>
                                                <p className="font-medium text-slate-700 text-sm">{ketPerbaikan}</p>
                                            </div>
                                        )}
                                        <div>
                                                        ...
                                                        <div className="flex justify-between items-start">
                                                            ...
                                                            <div className="flex gap-1">
                                                                <button
                                                                    ...
                                                                    className="px-2 py-1 rounded-lg bg-white border border-slate-200 text-slate-600 hover:border-sky-400 hover:text-sky-600 transition-all text-[10px] font-medium"
                                                                >
...
export default DetailModalDataRiwayat;