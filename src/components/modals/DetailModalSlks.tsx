...
const BASE_URL_BERKAS = "https://simasn.pontianak.go.id/assets/berkas/Layanan/SLKS/";
...
export const DetailModalSlks: React.FC<DetailModalSlksProps> = ({
    isOpen,
    onClose,
    data
}) => {
    ...
    const availableFiles = slksFileConfig
                        ...
                        <div className="flex justify-between items-start">
                            <div>
                                <h2 className="text-xl font-black flex items-center gap-2">
                                    <Award size={24} />
                                    Detail Satya Lencana Karya Satya (SLKS)
                                </h2>
                                <p className="text-amber-100 text-xs mt-1">
                                    Informasi lengkap pengajuan usulan Satya Lencana Karya Satya
                                </p>
                            </div>
                            ...
                            <div className="md:col-span-1 space-y-4">
                                ...
                                <div className="text-center">
                                    {fotoUrl ? (
                                        <img
                                            src={fotoUrl}
                                            alt={namaLengkap}
                                            className="w-32 h-32 rounded-full object-cover mx-auto border-4 border-amber-200 shadow-lg"
                                            onError={(e) => {
                                                e.currentTarget.style.display = "none";
                                                const parent = e.currentTarget.parentElement;
                                                if (parent) {
                                                    const fallback = document.createElement('div');
                                                    fallback.className = "w-32 h-32 rounded-full bg-gradient-to-br from-amber-500 to-amber-600 text-white flex items-center justify-center text-5xl font-black mx-auto border-4 border-amber-200 shadow-lg";
                                ...
                                <div className="bg-slate-50 rounded-2xl p-4">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div>
                                            <p className="text-[10px] text-slate-400">Masa Kerja</p>
                                            <p className="font-medium text-slate-700 text-sm">{masaKerja}</p>
                                        </div>
                                        <div>
                            ...
                            <div className="md:col-span-2">
                                                        ...
                                                        <div className="flex justify-between items-start">
                                                            ...
                                                            <div className="flex gap-1">
                                                                <button
                                                                    ...
                                                                    className="px-2 py-1 rounded-lg bg-white border border-slate-200 text-slate-600 hover:border-amber-400 hover:text-amber-600 transition-all text-[10px] font-medium"
                                                                >
                                ...
                                {hasMoreFiles && (
                                    <button
                                        ...
                                        className="mt-3 w-full flex items-center justify-center gap-2 px-4 py-2 text-xs font-medium text-amber-600 bg-amber-50 rounded-xl hover:bg-amber-100 transition-colors"
                                    >
                                        {showAllFiles ? (
                                            <>
                                                <ChevronUp size={14} />
                                ...
                                {data.file_status_pelayanan && (
                                    <div className="mt-6">
                                        <h4 className="text-sm font-black text-slate-800 flex items-center gap-2 mb-3">
                                            <FileCheck size={16} className="text-amber-600" /> Berkas Hasil
                                        </h4>
                                        <div className="bg-amber-50 rounded-xl p-3 border border-amber-200">
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div className="flex-1">
                                                    <p className="text-xs font-semibold text-slate-700">SK / Piagam Satya Lencana</p>
                                                ...
                                                <div className="flex gap-1">
                                                    ...
                                                    <button
                                                        onClick={() => handlePreview(data.file_status_pelayanan_url, 'SK / Piagam Satya Lencana')}
                                                        className="px-2 py-1 rounded-lg bg-white border border-slate-200 text-slate-600 hover:border-amber-400 hover:text-amber-600 transition-all text-[10px] font-medium"
                                                    >
                                                        <Eye size={10} className="inline mr-1" /> Preview
                                                    </button>
...
export default DetailModalSlks;