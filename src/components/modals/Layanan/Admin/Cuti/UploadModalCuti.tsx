// src/components/modals/Layanan/Admin/Cuti/UploadModalCuti.tsx
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (mode === 'edit' && onEdit) {
                ...
                await onEdit(data.layanan_cuti_id || data.id, oldFileName, uploadFile);
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-xl font-black">
                                {mode === 'edit' ? 'Ganti Berkas Hasil Cuti' : 'Upload Berkas Hasil Cuti'}
                            </h2>
                        </div>
                        {mode === 'edit' && (
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="mb-4">
                        ...
                        <div
                            className={`border-2 border-dashed rounded-2xl p-6 text-center transition-all cursor-pointer
                                ${error ? 'border-red-300 bg-red-50' : 'border-slate-200 hover:border-cyan-500 bg-slate-50 hover:bg-cyan-50'}
                            `}
                            onClick={() => document.getElementById('uploadFileInputCuti')?.click()}
                        >
                        ...
                        <p className="text-[10px] text-slate-400 mt-3">
                            {mode === 'edit'
                                ...
                                : 'Pastikan berkas yang diupload adalah SK / Keputusan Cuti hasil akhir yang sudah diverifikasi'
                            }
                        </p>
                    </div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            ...
                            className="flex-1 px-4 py-2 bg-cyan-500 text-white rounded-xl text-sm font-bold hover:bg-cyan-600 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
