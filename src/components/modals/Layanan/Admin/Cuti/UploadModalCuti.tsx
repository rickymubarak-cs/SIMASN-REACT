    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-3xl max-w-md w-full max-h-[90vh] shadow-2xl flex flex-col" style={{ animation: 'fadeIn 0.2s ease-out' }}>
                ...
                {/* Header - Fixed */}
                <div className="bg-gradient-to-r from-cyan-500 to-cyan-600 text-white p-6 rounded-t-3xl flex-shrink-0">
                        ...
                        >
                            {isDragOver ? (
                                <div className="animate-bounce">
                                    <Upload size={32} className="mx-auto mb-2 text-cyan-500" />
