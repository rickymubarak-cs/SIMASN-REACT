        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-3xl max-w-md w-full shadow-2xl animate-fadeIn">
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="mb-4 bg-sky-50 rounded-xl p-4">
                        <p className="text-[10px] font-bold text-sky-600 uppercase tracking-wider mb-3">Detail Usulan</p>
                        <div>
                            <p className="text-[9px] text-slate-400">Nama Diklat</p>
                            <p className="text-sm font-bold text-sky-700 line-clamp-2">{namaDiklat}</p>
                        </div>
                        <div className="mt-2">
                            <p className="text-[9px] text-slate-400">Tanggal Pengajuan</p>
                            <p className="text-sm font-bold text-sky-700">{data.timestamp ? new Date(data.timestamp).toLocaleDateString('id-ID') : "-"}</p>
                        </div>
                    </div>
