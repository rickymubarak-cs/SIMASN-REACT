...
export const UploadModalGaji: React.FC<UploadModalGajiProps> = ({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError("Gagal upload berkas. Silakan coba lại.");
        } finally {
            setUploading(false);
        }
    };
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-3xl max-w-md w-full max-h-[90vh] shadow-2xl flex flex-col" style={{ animation: 'fadeIn 0.2s ease-out' }}>
                ...
                {/* Header - Fixed */}
                <div className="bg-gradient-to-r from-teal-500 to-teal-600 text-white p-6 rounded-t-3xl flex-shrink-0">
                ...
                <form onSubmit={handleSubmit} className="p-6 flex-1 overflow-y-auto">
                        ...
                        <div
                            className={`
                                ...
                                ${isDragOver
                                    ...
                                    : 'border-slate-200 hover:border-teal-500 bg-slate-50 hover:bg-teal-50'
                                }
                            `}
                        ...
                        >
                            {isDragOver ? (
                                <div className="animate-bounce">
                                    <Upload size={32} className="mx-auto mb-2 text-teal-500" />
                    ...
                    {/* Buttons - Fixed di Bottom dalam scroll area */}
