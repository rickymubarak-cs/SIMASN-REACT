// src/components/modals/Layanan/Admin/Jf/UploadModalJf.tsx
                    ...
                    <div className="mb-4">
                        ...
                        <div
                            className={`border-2 border-dashed rounded-2xl p-6 text-center transition-all cursor-pointer
                                ${error ? 'border-red-300 bg-red-50' : 'border-slate-200 hover:border-indigo-500 bg-slate-50 hover:bg-indigo-50'}
                            `}
                            onClick={() => document.getElementById('uploadFileInputJf')?.click()}
                        >
