...
import { X, Upload, FileCheck, RefreshCcw, User, Briefcase, Building, AlertCircle } from 'lucide-react';
...
export const UploadModalJf: React.FC<UploadModalJfProps> = ({
    ...
    // Drag & Drop handlers - SAMA PERSIS dengan UploadModalGaji
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (mode === 'edit' && onEdit) {
                ...
                await onEdit(data.layanan_jf_id || data.id, oldFileName, uploadFile);
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            {/* Sama persis dengan struktur UploadModalGaji */}
            <div className="relative bg-white rounded-3xl max-w-md w-full max-h-[90vh] shadow-2xl flex flex-col" style={{ animation: 'fadeIn 0.2s ease-out' }}>
                ...
                {/* Header */}
                <div className="bg-gradient-to-r from-indigo-500 to-indigo-600 text-white p-6 rounded-t-3xl flex-shrink-0">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <Upload size={24} />
                            <h2 className="text-xl font-black">
                                {mode === 'edit' ? 'Ganti Berkas Hasil Jabatan Fungsional' : 'Upload Berkas Hasil Jabatan Fungsional'}
                            </h2>
                        </div>
                        {mode === 'edit' && (
                ...
                <form onSubmit={handleSubmit} className="p-6 flex-1 overflow-y-auto">
                    ...
                    {/* Upload Area dengan Drag & Drop - SAMA PERSIS dengan Gaji */}
                    <div className="mb-4">
                        ...
                        <div
                            className={`
                                ...
                                ${isDragOver
                                    ...
                                    : 'border-slate-200 hover:border-indigo-500 bg-slate-50 hover:bg-indigo-50'
                                }
                            `}
                        ...
                        <p className="text-[10px] text-slate-400 mt-3">
                            {mode === 'edit'
                                ...
                                : 'Pastikan berkas yang diupload adalah SK Jabatan Fungsional hasil akhir yang sudah diverifikasi'
                            }
                        </p>
                    </div>
                    ...
                    <div className="flex gap-3 pt-2 pb-1 sticky bottom-0 bg-white">
                        ...
                        <button
                            ...
                            className="flex-1 px-4 py-2 bg-indigo-500 text-white rounded-xl text-sm font-bold hover:bg-indigo-600 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
