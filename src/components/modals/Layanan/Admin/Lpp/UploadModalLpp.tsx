// src/components/modals/Layanan/Admin/Lpp/UploadModalLpp.tsx
...
export const UploadModalLpp: React.FC<UploadModalLppProps> = ({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!allowedTypes.includes(uploadFile.type)) {
            setError("Hanya file PDF, PNG, JPG, atau JPEG yang diperbolehkan");
            return;
        }
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-xl font-black">
                                {mode === 'edit' ? 'Ganti Berkas Hasil LPP' : 'Upload Berkas Hasil LPP'}
                            </h2>
                        </div>
                        {mode === 'edit' && (
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="mb-4">
                        ...
                        <div
                            ...
                            `}
                            onClick={() => document.getElementById('uploadFileInputLpp')?.click()}
                        >
                        ...
                        <p className="text-[10px] text-slate-400 mt-3">
                            {mode === 'edit'
                                ...
                                : 'Pastikan berkas yang diupload adalah SK / Keputusan LPP hasil akhir yang sudah diverifikasi'
                            }
                        </p>
                    </div>
