// src/components/modals/Layanan/Admin/Pangkat/UploadModalPangkat.tsx
                    ...
                    <div className="mb-4">
                        ...
                        <div
                            className={`border-2 border-dashed rounded-2xl p-6 text-center transition-all cursor-pointer
                                ${error ? 'border-red-300 bg-red-50' : 'border-slate-200 hover:border-purple-500 bg-slate-50 hover:bg-purple-50'}
                            `}
