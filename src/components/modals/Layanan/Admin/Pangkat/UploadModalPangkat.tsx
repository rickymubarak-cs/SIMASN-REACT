// src/components/modals/UploadModalPangkat.tsx
            ...
            <div className="relative bg-white rounded-3xl max-w-md w-full shadow-2xl animate-fadeIn">
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="mb-4 bg-purple-50 rounded-xl p-4">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-bold text-purple-700">{data.gol_id || "-"}</p>
                            </div>
                            <div>
                    ...
                    <div className="mb-4">
                        ...
                        <div className={`border-2 border-dashed rounded-2xl p-6 text-center transition-all cursor-pointer ${error ? 'border-red-300 bg-red-50' : 'border-slate-200 hover:border-purple-500 bg-slate-50 hover:bg-purple-50'}`} onClick={() => document.getElementById('uploadFileInputPangkat')?.click()}>
                            ...
                            <input id="uploadFileInputPangkat" type="file" accept=".pdf" className="hidden" onChange={(e) => { if (e.target.files?.[0]) { setError(null); setUploadFile(e.target.files[0]); } }} />
                        </div>
                        {uploadFile && (
                        ...
                        <p className="text-[10px] text-slate-400 mt-3">
                            Pastikan berkas yang diupload adalah SK Kenaikan Pangkat hasil akhir yang sudah diverifikasi dan ditandatangani.
                        </p>
                    </div>
                    ...
                    <div className="flex gap-3 mt-6">
                        ...
                        <button type="submit" disabled={uploading || !uploadFile} className="flex-1 px-4 py-2 bg-purple-500 text-white rounded-xl text-sm font-bold hover:bg-purple-600 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed">
