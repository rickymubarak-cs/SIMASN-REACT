    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (mode === 'edit' && onEdit) {
                ...
                await onEdit(data.layanan_pemberhentian_id || data.id, oldFileName, uploadFile);
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-3xl max-w-md w-full max-h-[90vh] shadow-2xl flex flex-col" style={{ animation: 'fadeIn 0.2s ease-out' }}>
                ...
                <div className="bg-gradient-to-r from-rose-500 to-rose-600 text-white p-6 rounded-t-3xl flex-shrink-0">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <Upload size={24} />
                            <h2 className="text-xl font-black">
                                {mode === 'edit' ? 'Ganti Berkas Hasil Pemberhentian ASN' : 'Upload Berkas Hasil Pemberhentian ASN'}
                            </h2>
                        </div>
                        {mode === 'edit' && (
                    ...
                    <div className="mb-4 bg-rose-50 rounded-xl p-4">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-bold text-rose-700">{golongan}</p>
                            </div>
                            <div>
                    ...
                    <div className="mb-4">
                        ...
                        <div
                            className={`
                                ...
                                ${isDragOver
                                    ...
                                    : 'border-slate-200 hover:border-rose-500 bg-slate-50 hover:bg-rose-50'
                                }
                            `}
                        ...
                        >
                            {isDragOver ? (
                                <div className="animate-bounce">
                                    <Upload size={32} className="mx-auto mb-2 text-rose-500" />
                        ...
                        <p className="text-[10px] text-slate-400 mt-3">
                            {mode === 'edit'
                                ...
                                : 'Pastikan berkas yang diupload adalah SK Pemberhentian ASN hasil akhir yang sudah diverifikasi'
                            }
                        </p>
                    </div>
