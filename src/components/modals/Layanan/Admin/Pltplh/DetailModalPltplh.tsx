// src/components/modals/Layanan/Admin/Pltplh/DetailModalPltplh.tsx

import React, { useState } from 'react';
import {
    X, User, Building, Paperclip, FileCheck, Clock, Info, UserCog, ChevronDown, ChevronUp,
...
import { pltplhFileConfig } from '../../../../../service/pltplhService';

interface DetailModalPltplhProps {
    isOpen: boolean;
    onClose: () => void;
    data: any;
}
...
const BASE_URL_BERKAS = "https://simasn.pontianak.go.id/assets/berkas/Layanan/PltPlh/";
...
export const DetailModalPltplh: React.FC<DetailModalPltplhProps> = ({
    isOpen,
    onClose,
    data
}) => {
    ...
    const availableFiles = pltplhFileConfig
                        ...
                        <div className="flex justify-between items-start">
                            <div>
                                <h2 className="text-xl font-black flex items-center gap-2">
                                    <UserCog size={24} />
                                    Detail Pelaksana Tugas (PLT/PLH)
                                </h2>
                                <p className="text-emerald-100 text-xs mt-1">
                                    Informasi lengkap pengajuan usulan Pelaksana Tugas (PLT) dan Pejabat Laksana Harian (PLH)
                                </p>
                            </div>
                            ...
                            <div className="md:col-span-1 space-y-4">
                                ...
                                <div className="bg-slate-50 rounded-2xl p-4">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div>
                                            <p className="text-[10px] text-slate-400">Jenis PLT/PLH</p>
                                            <p className="font-medium text-slate-700 text-sm">{jenisPltplh}</p>
                                        </div>
                                        <div>
                                    ...
                                    <div className="mt-6">
                                        ...
                                        <div className="bg-emerald-50 rounded-xl p-3 border border-emerald-200">
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div className="flex-1">
                                                    <p className="text-xs font-semibold text-slate-700">SK / Keputusan PLT/PLH</p>
                                                ...
                                                <div className="flex gap-1">
                                                    ...
                                                    <button onClick={() => handlePreview(data.file_status_pelayanan_url, 'SK / Keputusan PLT/PLH')} className="px-2 py-1 rounded-lg bg-white border border-slate-200 text-slate-600 hover:border-emerald-400 hover:text-emerald-600 transition-all text-[10px] font-medium">
                                                        <Eye size={10} className="inline mr-1" /> Preview
                                                    </button>
                                                </div>
                                            </div>
...
export default DetailModalPltplh;