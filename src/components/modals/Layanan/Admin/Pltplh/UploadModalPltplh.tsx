// src/components/modals/UploadModalPltplh.tsx
import React, { useState } from 'react';
import { X, Upload, FileCheck, RefreshCcw, User, UserCog, Building } from 'lucide-react';
                ...
                <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6 rounded-t-3xl">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <Upload size={24} />
                            <h2 className="text-xl font-black">Upload Berkas Hasil PLT/PLH</h2>
                        </div>
                        <button
                            onClick={onClose}
                            disabled={uploading}
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="mb-4 bg-blue-50 rounded-xl p-4">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                ...
                                <p className="text-sm font-bold text-blue-700">{jenisPltplh}</p>
                            </div>
                            <div>
                                <p className="text-[9px] text-slate-400">Tanggal Pengajuan</p>
                                <p className="text-sm font-bold text-blue-700">
                                    {data.timestamp ? new Date(data.timestamp).toLocaleDateString('id-ID') : "-"}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <p className="text-[10px] text-slate-400 mt-3">
                            Pastikan berkas yang diupload adalah SK / Keputusan PLT/PLH
