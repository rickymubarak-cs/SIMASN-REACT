...
import { X, Upload, FileCheck, RefreshCcw, User, Award } from 'lucide-react';

interface UploadModalSlksProps {
    isOpen: boolean;
    onClose: () => void;
...
export const UploadModalSlks: React.FC<UploadModalSlksProps> = ({
    isOpen,
    onClose,
    onSubmit,
    data
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-3xl max-w-md w-full shadow-2xl animate-fadeIn">
                <div className="bg-gradient-to-r from-amber-500 to-amber-600 text-white p-6 rounded-t-3xl">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <Upload size={24} />
                            <h2 className="text-xl font-black">Upload Berkas Hasil SLKS</h2>
                        </div>
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="mb-4">
                        <label className="block text-xs font-bold text-slate-600 mb-2">Masa Kerja</label>
                        <div className="p-3 bg-slate-50 rounded-xl border border-slate-200">
                            <p className="text-xs text-slate-700">{masaKerja}</p>
                        </div>
                    </div>
                    ...
                    <div className="mb-6">
                        ...
                        <div
                            className="border-2 border-dashed border-slate-200 rounded-2xl p-6 text-center hover:border-amber-500 transition-colors cursor-pointer"
                            onClick={() => document.getElementById('uploadFileInputSlks')?.click()}
                        >
                        ...
                        <p className="text-[10px] text-slate-400 mt-2">
                            Pastikan berkas yang diupload adalah SK / Piagam Satya Lencana hasil akhir yang sudah diverifikasi
                        </p>
                    </div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            ...
                            className="flex-1 px-4 py-2 bg-amber-500 text-white rounded-xl text-sm font-bold hover:bg-amber-600 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
...
export default UploadModalSlks;