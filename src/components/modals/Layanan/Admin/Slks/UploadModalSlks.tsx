// src/components/modals/Layanan/Admin/Slks/UploadModalSlks.tsx

import React, { useState, useEffect } from 'react';
import { X, Upload, FileCheck, RefreshCcw, User, Award, AlertCircle } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-3xl max-w-md w-full shadow-2xl animate-fadeIn">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-xl font-black">
                                {mode === 'edit' ? 'Ganti Berkas Hasil SLKS' : 'Upload Berkas Hasil SLKS'}
                            </h2>
                        </div>
                        {mode === 'edit' && (
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    {/* Informasi Berkas Lama (untuk mode edit) */}
                    ...
                    <div className="mb-4">
                        ...
                        <div
                            className={`border-2 border-dashed rounded-2xl p-6 text-center transition-all cursor-pointer
                                ${error ? 'border-red-300 bg-red-50' : 'border-slate-200 hover:border-amber-500 bg-slate-50 hover:bg-amber-50'}
                            `}
