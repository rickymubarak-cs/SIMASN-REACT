...
export const UploadModalTubel: React.FC<UploadModalTubelProps> = ({
    isOpen,
    onClose,
    onSubmit,
    onEdit,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (mode === 'edit' && onEdit) {
                ...
                await onEdit(data.layanan_tubel_id || data.id, oldFileName, uploadFile);
            ...
            <div className="relative bg-white rounded-3xl max-w-md w-full shadow-2xl animate-fadeIn">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-xl font-black">
                                {mode === 'edit' ? 'Ganti Berkas Hasil Tugas Belajar' : 'Upload Berkas Hasil Tugas Belajar'}
                            </h2>
                        </div>
                        {mode === 'edit' && (
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="mb-4 bg-blue-50 rounded-xl p-4">
                        <p className="text-[10px] font-bold text-blue-600 uppercase tracking-wider mb-3">Detail Usulan</p>
                    ...
                    <div className="mb-4">
                        ...
                        <p className="text-[10px] text-slate-400 mt-3">
                            {mode === 'edit'
                                ...
                                : 'Pastikan berkas yang diupload adalah SK / Keputusan Tugas Belajar hasil akhir yang sudah diverifikasi'
                            }
                        </p>
                    </div>
...
export default UploadModalTubel;