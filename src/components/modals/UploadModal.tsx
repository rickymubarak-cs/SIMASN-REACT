...
import { X, Upload, FileCheck, RefreshCcw, User } from 'lucide-react';
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="mb-6">
                        ...
                        <p className="text-[10px] text-slate-400 mt-2">
                            Pastikan berkas yang diupload adalah hasil akhir yang sudah diverifikasi
                        </p>
                    </div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            type="submit"
                            disabled={uploading}
                            className="flex-1 px-4 py-2 bg-emerald-500 text-white rounded-xl text-sm font-bold hover:bg-emerald-600 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                        >
