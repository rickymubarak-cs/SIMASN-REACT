...
import { X, Upload, FileCheck, RefreshCcw, User, Coffee } from 'lucide-react';
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="mb-6">
                        ...
                        <p className="text-[10px] text-slate-400 mt-2">
                            Pastikan berkas yang diupload adalah SK Cuti / Surat Keputusan hasil akhir yang sudah diverifikasi
                        </p>
                    </div>
