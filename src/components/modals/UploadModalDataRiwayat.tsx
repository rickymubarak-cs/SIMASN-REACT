...
import { X, Upload, FileCheck, RefreshCcw, User, Database } from 'lucide-react';

interface UploadModalDataRiwayatProps {
    isOpen: boolean;
    onClose: () => void;
...
export const UploadModalDataRiwayat: React.FC<UploadModalDataRiwayatProps> = ({
    isOpen,
    onClose,
    onSubmit,
    data
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-3xl max-w-md w-full shadow-2xl animate-fadeIn">
                <div className="bg-gradient-to-r from-sky-500 to-sky-600 text-white p-6 rounded-t-3xl">
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="mb-6">
                        ...
                        <div
                            className="border-2 border-dashed border-slate-200 rounded-2xl p-6 text-center hover:border-sky-500 transition-colors cursor-pointer"
                            onClick={() => document.getElementById('uploadFileInputData')?.click()}
                        >
...
export default UploadModalDataRiwayat;