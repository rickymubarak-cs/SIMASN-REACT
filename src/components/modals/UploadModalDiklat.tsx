    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-3xl max-w-md w-full shadow-2xl animate-fadeIn">
                <div className="bg-gradient-to-r from-violet-500 to-violet-600 text-white p-6 rounded-t-3xl">
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="mb-4">
                        <label className="block text-xs font-bold text-slate-600 mb-2">Nama Usulan Diklat</label>
                        <div className="p-3 bg-slate-50 rounded-xl border border-slate-200">
                            <p className="text-xs text-slate-700 line-clamp-3">{namaUsulan}</p>
                        </div>
                    </div>
                    ...
                    <div className="mb-6">
                        ...
                        <div
                            className="border-2 border-dashed border-slate-200 rounded-2xl p-6 text-center hover:border-violet-500 transition-colors cursor-pointer"
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            ...
                            className="flex-1 px-4 py-2 bg-violet-500 text-white rounded-xl text-sm font-bold hover:bg-violet-600 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
...
export default UploadModalDiklat;