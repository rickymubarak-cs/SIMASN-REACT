...
import { X, Upload, FileCheck, RefreshCcw, User, Wallet } from 'lucide-react';
            ...
            <div className="relative bg-white rounded-3xl max-w-md w-full shadow-2xl animate-fadeIn">
                <div className="bg-gradient-to-r from-teal-500 to-teal-600 text-white p-6 rounded-t-3xl">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <Upload size={24} />
                            <h2 className="text-xl font-black">Upload Berkas Hasil KGB</h2>
                        </div>
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="mb-6">
                        ...
                        <div
                            className="border-2 border-dashed border-slate-200 rounded-2xl p-6 text-center hover:border-teal-500 transition-colors cursor-pointer"
                        ...
                        <p className="text-[10px] text-slate-400 mt-2">
                            Pastikan berkas yang diupload adalah SK Kenaikan Gaji Berkala hasil akhir yang sudah diverifikasi
                        </p>
                    </div>
