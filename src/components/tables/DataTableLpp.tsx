...
export const DataTableLpp: React.FC<DataTableLppProps> = ({
    data,
    startIndex,
    onDetail,
    onPerbaiki,
        ...
        filtered.sort((a, b) => {
            ...
            switch (sortField) {
                ...
                case 'tanggal':
                    ...
                    break;
                case 'status':
                    aVal = a.layanan_lpp_status || '';
                    bVal = b.layanan_lpp_status || '';
                    break;
                default:
                    return 0;
            }
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            {filteredAndSortedData.length === 0 && (
                <div className="text-center py-12">
                    ...
                    <p className="text-slate-500">Tidak ada data LPP yang ditemukan</p>
                </div>
            )}
        </div>
    );
