...
interface DataTablePltplhProps {
    data: any[];
    startIndex: number;
...
export const DataTablePltplh: React.FC<DataTablePltplhProps> = ({
    data,
    startIndex,
    onDetail,
    onPerbaiki,
        ...
        filtered.sort((a, b) => {
            ...
            switch (sortField) {
                ...
                case 'tanggal':
                    ...
                    break;
                case 'status':
                    aVal = a.layanan_pltplh_status || '';
                    bVal = b.layanan_pltplh_status || '';
                    break;
                case 'jenis':
                    aVal = a.layanan_pltplh_pengajuan || '';
                    bVal = b.layanan_pltplh_pengajuan || '';
                    break;
                default:
                    return 0;
            }
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            {filteredAndSortedData.length === 0 && (
                <div className="text-center py-12">
                    ...
                    <p className="text-slate-500">Tidak ada data PLT/PLH yang ditemukan</p>
                </div>
            )}
        </div>
    );
