...
export default function Cuti({ activeTab, onTabChange }: CutiProps) {
    ...
    const handleEditBerkas = async (id: string, oldFile: string, newFile: File) => {
        ...
        try {
            await cutiService.editBerkas(id, oldFile, newFile);
        ...
        if (paginatedData.length === 0) {
            return (
                <div className="text-center py-20 bg-white rounded-3xl shadow-sm">
                    ...
                    <h3 className="text-2xl font-black text-slate-800 uppercase tracking-tight">Belum Ada Usulan Cuti</h3>
                    <p className="text-slate-500 text-sm mt-2 max-w-md mx-auto">
                        Saat ini belum terdapat pengajuan usulan Cuti
                ...
                <div className="bg-gradient-to-r from-cyan-600 to-cyan-700 rounded-3xl p-6 text-white">
                    <div className="mb-4">
                        ...
                        <p className="text-cyan-100 text-sm">
                            Kelola dan pantau pengajuan usulan Cuti Pegawai ASN
                        </p>
                    </div>
