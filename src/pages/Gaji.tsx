...
import { DataCardGaji } from '../components/cards/DataCardGaji';
...
export default function Gaji({ activeTab, onTabChange }: GajiProps) {
    ...
    const { data, loading, error, perangkatDaerah, setPerangkatDaerah, refreshData } = useGajiData();
    const itemsPerPage = 8;

    useEffect(() => {
        console.log('Gaji Page - Data:', data);
        console.log('Gaji Page - Data count:', data.length);
    }, [data]);
    ...
    const handleLocalTabChange = (tab: string) => {
        console.log('Gaji - handleLocalTabChange called with:', tab);
        onTabChange(tab);
    };
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
                ...
                <div className="bg-gradient-to-r from-teal-600 to-teal-700 rounded-3xl p-6 text-white">
                    ...
                    <p className="text-teal-100 text-sm">
                        Kelola dan pantau pengajuan kenaikan gaji berkala ASN
                    </p>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20 bg-white rounded-3xl shadow-sm">
                        ...
                        <h3 className="text-2xl font-black text-slate-800 uppercase tracking-tight">Belum Ada Data KGB</h3>
                        <p className="text-slate-500 text-sm mt-2 max-w-md mx-auto">
                            Saat ini belum terdapat pengajuan kenaikan gaji berkala
