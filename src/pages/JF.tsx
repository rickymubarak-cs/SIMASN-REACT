...
export default function Jf({ activeTab, onTabChange }: JfProps) {
    ...
    const handleEditBerkas = async (id: string, oldFile: string, newFile: File) => {
        ...
        try {
            await jfService.editBerkas(id, oldFile, newFile);
        ...
        if (paginatedData.length === 0) {
            return (
                <div className="text-center py-20 bg-white rounded-3xl shadow-sm">
                    ...
                    <h3 className="text-2xl font-black text-slate-800 uppercase tracking-tight">Belum Ada Usulan Jabatan Fungsional</h3>
                    <p className="text-slate-500 text-sm mt-2 max-w-md mx-auto">
                        Saat ini belum terdapat pengajuan usulan Jabatan Fungsional
                ...
                <div className="bg-gradient-to-r from-indigo-600 to-indigo-700 rounded-3xl p-6 text-white">
                    <div className="mb-4">
                        ...
                        <p className="text-indigo-100 text-sm">
                            Kelola dan pantau pengajuan usulan Jabatan Fungsional ASN
                        </p>
                    </div>
