...
export default function Lpp({ activeTab, onTabChange }: LppProps) {
    ...
    const handleEditBerkas = async (id: string, oldFile: string, newFile: File) => {
        ...
        try {
            await lppService.editBerkas(id, oldFile, newFile);
        ...
        if (paginatedData.length === 0) {
            return (
                <div className="text-center py-20 bg-white rounded-3xl shadow-sm">
                    ...
                    <h3 className="text-2xl font-black text-slate-800 uppercase tracking-tight">Belum Ada Usulan LPP</h3>
                    <p className="text-slate-500 text-sm mt-2 max-w-md mx-auto">
                        Saat ini belum terdapat pengajuan usulan Laporan Peningkatan Pendidikan
                ...
                <div className="bg-gradient-to-r from-emerald-600 to-emerald-700 rounded-3xl p-6 text-white">
                    <div className="mb-4">
                        <h1 className="text-2xl font-black mb-1">
                            Laporan Peningkatan Pendidikan (LPP)
                        </h1>
                        <p className="text-emerald-100 text-sm">
                            Kelola dan pantau pengajuan usulan Pencatuman Gelar / Peningkatan Pendidikan
                        </p>
                    </div>
