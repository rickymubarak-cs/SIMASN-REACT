...
interface TubelProps {
    activeTab: string;
    onTabChange: (tab: string) => void;
}

export default function Tubel({ activeTab, onTabChange }: TubelProps) {
    ...
    const { data, loading, error, perangkatDaerah, setPerangkatDaerah, refreshData } = useTubelData();
    const itemsPerPage = 8;

    useEffect(() => {
        console.log('Tubel Page - Data:', data);
        console.log('Tubel Page - Data count:', data.length);
    }, [data]);
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
                ...
                <div className="bg-gradient-to-r from-emerald-600 to-emerald-700 rounded-3xl p-6 text-white">
                    ...
                    <p className="text-emerald-100 text-sm">
                        Kelola dan pantau pengajuan izin tugas belajar pegawai
                    </p>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20 bg-white rounded-3xl shadow-sm">
                        ...
                        <h3 className="text-2xl font-black text-slate-800 uppercase tracking-tight">Belum Ada Data Tugas Belajar</h3>
                        <p className="text-slate-500 text-sm mt-2 max-w-md mx-auto">
                            Saat ini belum terdapat pengajuan izin tugas belajar
