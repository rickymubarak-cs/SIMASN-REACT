...
export default function Tubel({ activeTab, onTabChange }: TubelProps) {
    ...
    const { data, loading, error, refreshData } = useTubelData();
        ...
        if (paginatedData.length === 0) {
            return (
                <div className="text-center py-20 bg-white rounded-3xl shadow-sm">
                    ...
                    <h3 className="text-2xl font-black text-slate-800 uppercase tracking-tight">Belum Ada Usulan Tugas Belajar</h3>
                    <p className="text-slate-500 text-sm mt-2 max-w-md mx-auto">
                        Saat ini belum terdapat pengajuan usulan Tugas Belajar
                ...
                <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-3xl p-6 text-white">
                    <div className="mb-4">
                        ...
                        <p className="text-blue-100 text-sm">
                            Kelola dan pantau pengajuan usulan Tugas Belajar pegawai
                        </p>
                    </div>
